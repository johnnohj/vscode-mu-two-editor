...
import { IBoard, BoardType, BoardConnectionState, BoardCapabilities, ExecutionResult, FileInfo, DeviceInfo } from '../devices/management/boardManager';
import { CircuitPythonRepl, ReplState, ReplMode, ReplCommand } from '../devices/common/repl';
