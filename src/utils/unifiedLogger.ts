...
export class UnifiedLogger {
    ...
    log(category: LogCategory, level: LogLevel, message: string, data?: any): void {
        ...
        // Note: Auto-show disabled to prevent focus stealing during development
        // Users can manually open the Mu 2 output channel to see errors
    }
    ...
    showDeviceComm(): void {
        if (this.deviceCommChannel) {
            this.deviceCommChannel.show(false);
        }
    }
